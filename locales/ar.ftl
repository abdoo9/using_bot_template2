...
set_group = 
    ...
    .bot_restricted_from_adminsGroup = لقد غادرت المجموعة لأن <b>{ $firstName }</b> منعني من إرسال الرسالة في <b>{ $title }</b>
    ...
    .how_to_set = تعيين مجموعة
    .how_to_set_url = https://t.me/+bJSfGztNJiU4NWU5
    .how_to_change = تغيير المجموعة
